        ...
        <div className='flex flex-col lg:flex-row py-10 mb-8 space-x-6 px-4'>
            <div className='mb-12 px-2'>
              <a href="/" data-analytics-event="{&quot;category&quot;:&quot;Footer&quot;,&quot;action&quot;:&quot;go to home&quot;,&quot;label&quot;:&quot;text:home&quot;}" className="color-fg-default d-inline-block" aria-label="Go to GitHub homepage">
                ...
                <h1 className='text-white text-2xl'>GitSpace</h1>
              </a>
            ...
            <div className='lg:flex w-full justify-between grid md:grid-cols-4 grid-cols-2 gap-6'>
              <div className='text-[#7d8590]'>
                ...
                <ul className='text-[14px]'>
                    ...
                    <li className='mb-4'><a href="">Compare GitSpace</a></li>
                </ul>
              </div>
              <div className='text-[#7d8590]'>
                ...
                <ul className='text-[14px]'>
                    ...
                    <li className='mb-4'><a href="">GitSpace Desktop</a></li>
                </ul>
              </div>
              <div className='text-[#7d8590]'>
                <h2 className='font-medium mb-4 font-mono'>Product</h2>
                <ul className='text-[14px]'>
                    ...
                    <li className='mb-4'><a href="">Contact GitSpace</a></li>
                </ul>
              </div>
              <div className='text-[#7d8590]'>
      ...
      <div className='bg-[#161b22]'>
        <div className='max-w-[1280px] mx-auto text-[12px] md:flex flex-row-reverse py-6 justify-between items-center px-4'>
          <ul className='flex items-center max-md:mb-4  '>
            <li className='mr-4'>
              <a href="https://www.linkedin.com/in/abhishekh-yadav" target='_blank'><img src="https://github.githubassets.com/images/modules/site/icons/footer/linkedin.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
            <li>
              <a href="https://github.com/AbhishekhYadav263" target='_blank'><img src="https://github.githubassets.com/images/modules/site/icons/footer/github-mark.svg" height="18" width="22" className="d-block" loading="lazy" decoding="async" alt="Twitter icon" /></a>
            </li>
          </ul>
          <ul className='flex items-center mb-4 sm:mb-0 text-[#7d8590] flex-wrap' >
            <li className="mr-3 ">© 2024 GitSpace by Abhishekh Yadav</li>
